...
var __filename$1 = '/utils/filesList.js';
...
var filesListTF = (Module => {
  Module.defineUtil(__filename$1, globalContext$2.annotate(async (asFoldername, ahOptions = {}) => {
    let _asFoldernameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.union(globalContext$2.array(globalContext$2.string()), globalContext$2.ref("Promise", globalContext$2.array(globalContext$2.string()))));

    globalContext$2.param("asFoldername", _asFoldernameType).assert(asFoldername);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
  ...
  }, globalContext$2.function(globalContext$2.param("asFoldername", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.array(globalContext$2.string()))))));
});

var __filename$2 = '/utils/filesListSync.js';

var filesListSyncTF = (Module => {
  Module.defineUtil(__filename$2, globalContext$2.annotate((asFoldername, ahOptions = {}) => {
    let _asFoldernameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.array(globalContext$2.string()));

    globalContext$2.param("asFoldername", _asFoldernameType).assert(asFoldername);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(fs.readdirSync(asFoldername, ahOptions));
  }, globalContext$2.function(globalContext$2.param("asFoldername", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.array(globalContext$2.string())))));
});

var __filename$3 = '/utils/filesTree.js';

var filesTreeTF = (Module => {
  Module.defineUtil(__filename$3, globalContext$2.annotate(async (asFoldername, ahOptions = {}) => {
    let _asFoldernameType = globalContext$2.string();
    ...
    return _returnType.assert(await new Promise((resolve, reject) => {
      glob(`${asFoldername}/**/*`, ahOptions, async (err, data) => {
        ...
        if (ahOptions.filesOnly) {
          ...
          })).then(alPaths => alPaths.filter(([asPath, abIsFile]) => abIsFile).map(([asPath, abIsFile]) => path.relative(asFoldername, asPath))));
        } else {
...
var __filename$4 = '/utils/filesTreeSync.js';

var filesTreeSyncTF = (Module => {
  Module.defineUtil(__filename$4, globalContext$2.annotate((asFoldername, ahOptions = {}) => {
    let _asFoldernameType = globalContext$2.string();
    ...
    if (ahOptions.filesOnly) {
      return _returnType.assert(data.map(asPath => {
        try {
          return [asPath, fs.statSync(asPath).isFile()];
        } catch (err) {
          return [asPath, false];
        }
      }).filter(([asPath, abIsFile]) => abIsFile).map(([asPath, abIsFile]) => path.relative(asFoldername, asPath)));
    } else {
      return _returnType.assert(data.map(asPath => path.relative(asFoldername, asPath)));
    }
  }, globalContext$2.function(globalContext$2.param("asFoldername", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.array(globalContext$2.string())))));
});

var __filename$5 = '/utils/readFile.js';

var readFileTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$5, globalContext$2.annotate(async (asFilename, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.union(globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer")), globalContext$2.ref("Promise", globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer")))));

    globalContext$2.param("asFilename", _asFilenameType).assert(asFilename);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(await new Promise((resolve, reject) => {
      fs.readFile(asFilename, assign({
        encoding: 'utf8'
      }, ahOptions), (err, data) => {
        if (err != null) {
          reject(err);
  ...
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer")))))));
});

var __filename$6 = '/utils/readFileSync.js';

var readFileSyncTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$6, globalContext$2.annotate((asFilename, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer")));

    globalContext$2.param("asFilename", _asFilenameType).assert(asFilename);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(fs.readFileSync(asFilename, assign({
      encoding: 'utf8'
    }, ahOptions)));
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer"))))));
});

var __filename$7 = '/utils/writeFile.js';

var writeFileTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$7, globalContext$2.annotate(async (asFilename, data, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();
    ...
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(await new Promise((resolve, reject) => {
      fs.writeFile(asFilename, data, assign({
        encoding: 'utf8'
      }, ahOptions), err => {
        if (err != null) {
          reject(err);
  ...
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("data", globalContext$2.any()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer")))))));
});

var __filename$8 = '/utils/writeFileSync.js';

var writeFileSyncTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$8, globalContext$2.annotate((asFilename, data, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();
    ...
    globalContext$2.param("asFilename", _asFilenameType).assert(asFilename);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(fs.writeFileSync(asFilename, data, assign({
      encoding: 'utf8'
    }, ahOptions)));
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("data", globalContext$2.any()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.union(globalContext$2.string(), globalContext$2.ref("Buffer"))))));
});

var __filename$9 = '/utils/createReadStream.js';
...
var createReadStreamTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$9, globalContext$2.annotate((asFilename, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.ref(StreamT$1));

    globalContext$2.param("asFilename", _asFilenameType).assert(asFilename);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(fs.createReadStream(asFilename, assign({}, ahOptions)));
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref(StreamT$1)))));
});

var __filename$a = '/utils/createWriteStream.js';

const StreamT$2 = globalContext$2.tdz(() => StreamT);
var createWriteStreamTF = (Module => {
  const {
    Utils: {
      assign
    }
  } = Module.NS;
  Module.defineUtil(__filename$a, globalContext$2.annotate((asFilename, ahOptions = {}) => {
    let _asFilenameType = globalContext$2.string();

    let _ahOptionsType = globalContext$2.nullable(globalContext$2.ref("object"));

    const _returnType = globalContext$2.return(globalContext$2.ref(StreamT$2));

    globalContext$2.param("asFilename", _asFilenameType).assert(asFilename);
    globalContext$2.param("ahOptions", _ahOptionsType).assert(ahOptions);
    return _returnType.assert(fs.createWriteStream(asFilename, assign({
      encoding: 'utf8'
    }, ahOptions)));
  }, globalContext$2.function(globalContext$2.param("asFilename", globalContext$2.string()), globalContext$2.param("ahOptions", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref(StreamT$2)))));
});
...
var index = (Module => {
  ...
  let FsUtils = (_dec = globalContext$2.annotate(globalContext$2.class("FsUtils", globalContext$2.extends(LeanES), globalContext$2.staticProperty("__filename", globalContext$2.any()), globalContext$2.staticProperty("object", globalContext$2.any()))), _dec2 = resolver(require, name => require(name)), _dec(_class = filesListTF(_class = filesListSyncTF(_class = filesTreeTF(_class = filesTreeSyncTF(_class = readFileTF(_class = readFileSyncTF(_class = writeFileTF(_class = writeFileSyncTF(_class = createReadStreamTF(_class = createWriteStreamTF(_class = initialize(_class = _dec2(_class = (_class2 = (_temp = _class3 = class FsUtils extends LeanES {}, _class3.__filename = 'FsUtils', _class3.object = {}, _temp), (applyDecoratedDescriptor(_class2, "__filename", [nameBy], (_init = Object.getOwnPropertyDescriptor(_class2, "__filename"), _init = _init ? _init.value : undefined, {
    enumerable: true,
    configurable: true,
    writable: true,
  ...
  }), _class2)), _class2)) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class);
  return ['FsUtilsAddon', BaseClass => {
    var _dec3, _class4, _class5, _init3, _descriptor, _descriptor2, _class6, _temp2;

    let Mixin = (_dec3 = globalContext$2.annotate(globalContext$2.class("Mixin", globalContext$2.extends(BaseClass), globalContext$2.staticProperty("object", globalContext$2.any()), globalContext$2.property("glob", globalContext$2.any()), globalContext$2.property("FsUtils", globalContext$2.any()))), _dec3(_class4 = initializeMixin(_class4 = (_class5 = (_temp2 = _class6 = class Mixin extends BaseClass {
      constructor(...args) {
        super(...args);

        initializerDefineProperty(this, "glob", _descriptor, this);

        initializerDefineProperty(this, "FsUtils", _descriptor2, this);
      }

    }, _class6.object = {}, _temp2), (applyDecoratedDescriptor(_class5, "object", [meta], (_init3 = Object.getOwnPropertyDescriptor(_class5, "object"), _init3 = _init3 ? _init3.value : undefined, {
      enumerable: true,
      configurable: true,
      writable: true,
      initializer: function () {
    ...
    }), _class5), _descriptor = applyDecoratedDescriptor(_class5.prototype, "glob", [util], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor2 = applyDecoratedDescriptor(_class5.prototype, "FsUtils", [constant], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
